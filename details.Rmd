...
The owner of a rental property submits an application to the Department of Building and Housing to get a lead safe certification . The records provided to the Center on Urban Poverty and Community Development organize submitted applications into four categories to reflect the current status of the application: Pass, Fail, Pending, and Exempt. 
...
`Contact Interest Area` - Category definitions are coming soon. Interest area is missing if it was not captured by the intake staff.
